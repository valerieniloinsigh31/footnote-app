...
urlpatterns = [
    ...
    path('<slug:slug>/delete_footnote/<int:footnote_id>',
         views.footnote_delete, name='footnote_delete'),
    path('<slug:slug>/edit_footnote/<int:footnote_id>',
         views.footnote_edit, name='footnote_edit'),
]
